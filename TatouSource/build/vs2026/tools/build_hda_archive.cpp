...
// - backgrounds_hd.hda from PNG files in backgrounds_hd/ directory
// - atlases.hda from PNG files in atlases/ directory
//
// Usage: build_hda_archive <source_directory> <output_archive.hda>
//   Example: build_hda_archive "D:\FITD\Shipping\backgrounds_hd" "backgrounds_hd.hda"
//   Example: build_hda_archive "D:\FITD\Shipping\atlases" "atlases.hda"
//
///////////////////////////////////////////////////////////////////////////////
...
{
    // Direct mode: build_hda_archive <source_dir> <output_file>
    ...
    if (argc >= 3)
    {
        ...
        // Check if it looks like a directory path (no file extension or ends with \)
        bool isSourceDir = sourceDir.back() == '\\' || sourceDir.back() == '/';

        if (buildArchive(sourceDir, outputFile))
        {
            return 0;
        }
        return 1;
    ...
    // Show help
    printf("build_hda_archive - HD Asset Archive Builder\n");
    printf("Packages directory contents into HDBG archive format\n\n");
    printf("Usage: build_hda_archive <source_directory> <output_archive.hda>\n\n");
    printf("Examples:\n");
    printf("  build_hda_archive \"D:\\FITD\\Shipping\\backgrounds_hd\" \"backgrounds_hd.hda\"\n");
    printf("  build_hda_archive \"D:\\FITD\\Shipping\\atlases\" \"atlases.hda\"\n\n");
