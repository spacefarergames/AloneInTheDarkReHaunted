...
//
// Alone in the Dark 2 game-specific logic and startup sequence
///////////////////////////////////////////////////////////////////////////////
...
void drawInventoryAITD2()
{
	...
	{
	case 0: resIdx = AITD2_INVENTAIRE_PIRATE; break;
	case 1: resIdx = AITD2_INVENTAIRE_GANG; break;
	case 2: resIdx = AITD2_INVENTAIRE_GRACE; break;
	default: assert(0); return;
	}

	// Try HD replacement for inventory background
	...
	LoadPak("ITD_RESS", resIdx, logicalScreen);
...
void AITD2_ReadBook(int index, int type)
{
	...
	switch(type)
	{
	case 0: resIdx = AITD2_LETTRE; turnPageFlag = 0; break;
	case 1: resIdx = AITD2_LIVRE;  turnPageFlag = 1; break;
	case 2: resIdx = AITD2_CARNET; turnPageFlag = 0; break;
	default: assert(0); return;
	}
