...
//
// Global variable declarations and game data structures
///////////////////////////////////////////////////////////////////////////////
...
#else
// Release build stubs - debug visualization disabled
enum backgroundModeEnum
{
    backgroundModeEnum_2D,
    backgroundModeEnum_3D,
...
namespace {
    constexpr backgroundModeEnum backgroundMode = backgroundModeEnum_2D;
    constexpr collisiosDisplayMode hardColDisplayMode = displayNone;
    constexpr collisiosDisplayMode sceColDisplayMode = displayNone;
}
#endif
